    ...
    public function sendReport()
    {
        ...
        if (!$this->date && !is_null($this->oldDate)) {
            ...
            $deptBodys = [
                ...
                ['email' => 'sheldonnwosu@gmail.com', 'data' => ['name' => 'Sheldon Nwosu', 'dept' => 'Pastoral Care', 'co_members' => $this->co_pcu, 'co_early' => $this->earl_pcu, 'co_late' => $this->late_pcu, 'co_absent' => $this->abs_pcu, 'link' => url('/attendance/report/Pastoral Care/' . $this->date), 'date' => $this->date]],
                ['email' => 'akinpeluakinyinka@gmail.com', 'data' => ['name' => 'Akinyinka Akinpelu', 'dept' => 'Public Relations', 'co_members' => $this->co_pru, 'co_early' => $this->earl_pru, 'co_late' => $this->late_pru, 'co_absent' => $this->abs_pru, 'link' => url('/attendance/report/Public Relations/' . $this->date), 'date' => $this->date]],
                ...
                ['email' => 'robertihuoma@gmail.com.com', 'data' => ['name' => 'Robert Ihuoma', 'dept' => 'Ushering', 'co_members' => $this->co_usher, 'co_early' => $this->earl_usher, 'co_late' => $this->late_usher, 'co_absent' => $this->abs_usher, 'link' => url('/attendance/report/Ushering/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
            ...
            $deptBodys = [
                ...
                ['email' => 'robertihuoma@gmail.com.com', 'data' => ['name' => 'Robert Ihuoma', 'dept' => 'Ushering', 'co_members' => $this->co_usher, 'co_early' => $this->earl_usher, 'co_late' => $this->late_usher, 'co_absent' => $this->abs_usher, 'link' => url('/attendance/report/Ushering/' . $this->date), 'date' => $this->date]],
