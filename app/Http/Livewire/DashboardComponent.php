    ...
    public function sendReport()
    {
        ...
        if (!$this->date && !is_null($this->oldDate)) {
            ...
            $deptBodys = [
                ...
                ['email' => 'nneomaudeariry@gmail.com', 'data' => ['name' => 'Nneoma Ekeh', 'dept' => 'Child Care', 'co_members' => $this->co_childc, 'co_early' => $this->earl_childc, 'co_late' => $this->late_childc, 'co_absent' => $this->abs_childc, 'link' => url('/attendance/report/Child Care/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
                ['email' => 'mobbbikpd@gmail.com', 'data' => ['name' => 'Amobi Nwankwo', 'dept' => 'Decoration', 'co_members' => $this->co_deco, 'co_early' => $this->earl_deco, 'co_late' => $this->late_deco, 'co_absent' => $this->abs_deco, 'link' => url('/attendance/report/Decoration/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
                ['email' => 'just_ine2002@yahoo.com', 'data' => ['name' => 'Justin Masi', 'dept' => 'Drama', 'co_members' => $this->co_drama, 'co_early' => $this->earl_drama, 'co_late' => $this->late_drama, 'co_absent' => $this->abs_drama, 'link' => url('/attendance/report/Drama/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
                ...
                ['email' => 'akinpeluakinyinka@gmail.com', 'data' => ['name' => 'Akinyinka Akinpelu', 'dept' => 'Pastoral Care', 'co_members' => $this->co_pcu, 'co_early' => $this->earl_pcu, 'co_late' => $this->late_pcu, 'co_absent' => $this->abs_pcu, 'link' => url('/attendance/report/Pastoral Care/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
                ['email' => 'modupeativie@gmail.com', 'data' => ['name' => 'Modupe Ativie', 'dept' => 'Public Relations', 'co_members' => $this->co_pru, 'co_early' => $this->earl_pru, 'co_late' => $this->late_pru, 'co_absent' => $this->abs_pru, 'link' => url('/attendance/report/Public Relations/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
            ...
            $deptBodys = [
                ...
                ['email' => 'nneomaudeariry@gmail.com', 'data' => ['name' => 'Nneoma Ekeh', 'dept' => 'Child Care', 'co_members' => $this->co_childc, 'co_early' => $this->earl_childc, 'co_late' => $this->late_childc, 'co_absent' => $this->abs_childc, 'link' => url('/attendance/report/Child Care/' . $this->date), 'date' => $this->date]],
                ['email' => 'mobbbikpd@gmail.com', 'data' => ['name' => 'Amobi Nwankwo', 'dept' => 'Decoration', 'co_members' => $this->co_deco, 'co_early' => $this->earl_deco, 'co_late' => $this->late_deco, 'co_absent' => $this->abs_deco, 'link' => url('/attendance/report/Decoration/' . $this->date), 'date' => $this->date]],
                ['email' => 'just_ine2002@yahoo.com', 'data' => ['name' => 'Justin Masi', 'dept' => 'Drama', 'co_members' => $this->co_drama, 'co_early' => $this->earl_drama, 'co_late' => $this->late_drama, 'co_absent' => $this->abs_drama, 'link' => url('/attendance/report/Drama/' . $this->date), 'date' => $this->date]],
                ...
                ['email' => 'sheldonnwosu@gmail.com', 'data' => ['name' => 'Sheldon Nwosu', 'dept' => 'Host & Hostess', 'co_members' => $this->co_hnh, 'co_early' => $this->earl_hnh, 'co_late' => $this->late_hnh, 'co_absent' => $this->abs_hnh, 'link' => url('/attendance/report/Host & Hostess/' . $this->date), 'date' => $this->date]],
                ...
                ['email' => 'modupeativie@gmail.com', 'data' => ['name' => 'Modupe Ativie', 'dept' => 'Public Relations', 'co_members' => $this->co_pru, 'co_early' => $this->earl_pru, 'co_late' => $this->late_pru, 'co_absent' => $this->abs_pru, 'link' => url('/attendance/report/Public Relations/' . $this->date), 'date' => $this->date]],
