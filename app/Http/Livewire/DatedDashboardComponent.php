    ...
    public function sendReport()
    {
        ...
        if (!$this->date && !is_null($this->oldDate)) {
            ...
            $deptBodys = [
                ...
                ['email' => 'robertihuoma@gmail.com', 'data' => ['name' => 'Robert Ihuoma', 'dept' => 'Ushering', 'co_members' => $this->co_usher, 'co_early' => $this->earl_usher, 'co_late' => $this->late_usher, 'co_absent' => $this->abs_usher, 'link' => url('/attendance/report/Ushering/' . $this->date), 'date' => $this->date]],
