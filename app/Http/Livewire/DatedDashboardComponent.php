    ...
    public function sendReport()
    {
        ...
        if (!$this->date && !is_null($this->oldDate)) {
            ...
            $deptBodys = [
                ...
                ['email' => 'davemoses3@gmail.com', 'data' => ['name' => 'Justin Masi', 'dept' => 'Drama', 'co_members' => $this->co_drama, 'co_early' => $this->earl_drama, 'co_late' => $this->late_drama, 'co_absent' => $this->abs_drama, 'link' => url('/attendance/report/Drama/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
