    ...
    public function sendReport()
    {
        ...
        if (!$this->date && !is_null($this->oldDate)) {
            ...
            $deptBodys = [
                ...
                ['email' => 'akinpeluakinyinka@gmail.com', 'data' => ['name' => 'Akinyinka Akinpelu', 'dept' => 'Internship', 'co_members' => $this->co_intern, 'co_early' => $this->earl_intern, 'co_late' => $this->late_intern, 'co_absent' => $this->abs_intern, 'link' => url('/attendance/report/Internship/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
                ...
                ['email' => 'modupeativie@gmail.com', 'data' => ['name' => 'Modupe Ativie', 'dept' => 'Pastoral Care', 'co_members' => $this->co_pcu, 'co_early' => $this->earl_pcu, 'co_late' => $this->late_pcu, 'co_absent' => $this->abs_pcu, 'link' => url('/attendance/report/Pastoral Care/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
                ['email' => 'just_ine2002@yahoo.com', 'data' => ['name' => 'Justin Masi', 'dept' => 'Public Relations', 'co_members' => $this->co_pru, 'co_early' => $this->earl_pru, 'co_late' => $this->late_pru, 'co_absent' => $this->abs_pru, 'link' => url('/attendance/report/Public Relations/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
                ...
                ['email' => 'davemoses3@gmail.com', 'data' => ['name' => 'Nneoma Ekeh', 'dept' => 'Light', 'co_members' => $this->co_light, 'co_early' => $this->earl_light, 'co_late' => $this->late_light, 'co_absent' => $this->abs_light, 'link' => url('/attendance/report/Light/' . Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')), 'date' => Carbon::createFromFormat('Y-m-d H:i:s', $this->oldDate)->format('Y-m-d')]],
            ...
            //         ['email' => 'mobbbikpd@gmail.com', 'data' => ['name' => 'Amobi Nwankwo', 'dept' => 'Altar Management', 'co_members' => $this->co_alMan, 'co_early' => $this->earl_alMan, 'co_late' => $this->late_alMan, 'co_absent' => $this->abs_alMan, 'link' => url('/attendance/report/Altar Management/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'joycebong2012@gmail.com ', 'data' => ['name' => 'Joyce Ebong', 'dept' => 'Welfare', 'co_members' => $this->co_welfare, 'co_early' => $this->earl_welfare, 'co_late' => $this->late_welfare, 'co_absent' => $this->abs_welfare, 'link' => url('/attendance/report/Welfare/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'otisichidinma@gmail.com', 'data' => ['name' => 'Chidinma Joseph', 'dept' => 'COZA Transfer Service', 'co_members' => $this->co_cts, 'co_early' => $this->earl_cts, 'co_late' => $this->late_cts, 'co_absent' => $this->abs_cts, 'link' => url('/attendance/report/COZA Transfer Service/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'robertihuoma@gmail.com', 'data' => ['name' => 'Robert Ihuoma', 'dept' => 'Child Care', 'co_members' => $this->co_childc, 'co_early' => $this->earl_childc, 'co_late' => $this->late_childc, 'co_absent' => $this->abs_childc, 'link' => url('/attendance/report/Child Care/' . $this->date), 'date' => $this->date]],
            ...
            //         ['email' => 'leoativie@yahoo.com', 'data' => ['name' => 'Leo Ativie', 'dept' => 'Media', 'co_members' => $this->co_media, 'co_early' => $this->earl_media, 'co_late' => $this->late_media, 'co_absent' => $this->abs_media, 'link' => url('/attendance/report/Media/' . $this->date), 'date' => $this->date]],
            ...
            //         ['email' => 'edokaabel@gmail.com', 'data' => ['name' => 'Abel Edoka', 'dept' => 'Host & Hostess', 'co_members' => $this->co_hnh, 'co_early' => $this->earl_hnh, 'co_late' => $this->late_hnh, 'co_absent' => $this->abs_hnh, 'link' => url('/attendance/report/Host & Hostess/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'nneka.enang@yahoo.com', 'data' => ['name' => 'Nneka Enang', 'dept' => 'Partnership', 'co_members' => $this->co_partner, 'co_early' => $this->earl_partner, 'co_late' => $this->late_partner, 'co_absent' => $this->abs_partner, 'link' => url('/attendance/report/Partnership/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'nneka.enang@yahoo.com', 'data' => ['name' => 'Nneka Enang', 'dept' => 'Quality Control', 'co_members' => $this->co_qc, 'co_early' => $this->earl_qc, 'co_late' => $this->late_qc, 'co_absent' => $this->abs_qc, 'link' => url('/attendance/report/Quality Control/' . $this->date), 'date' => $this->date]],
            ...
            //         ['email' => 'nneomaudeariry@gmail.com', 'data' => ['name' => 'Nneoma Ekeh', 'dept' => 'M & E', 'co_members' => $this->co_mne, 'co_early' => $this->earl_mne, 'co_late' => $this->late_mne, 'co_absent' => $this->abs_mne, 'link' => url('/attendance/report/M & E/' . $this->date), 'date' => $this->date]],
            ...
            //         ['email' => 'fynceejay@gmail.com', 'data' => ['name' => 'Sunny Jacob', 'dept' => 'Traffic & Security', 'co_members' => $this->co_ts, 'co_early' => $this->earl_ts, 'co_late' => $this->late_ts, 'co_absent' => $this->abs_ts, 'link' => url('/attendance/report/Traffic & Security/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'sofiri.ezekiel.hart@gmail.com ', 'data' => ['name' => 'Sofiri Ezekiel-Hart', 'dept' => 'Ushering', 'co_members' => $this->co_usher, 'co_early' => $this->earl_usher, 'co_late' => $this->late_usher, 'co_absent' => $this->abs_usher, 'link' => url('/attendance/report/Ushering/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'aludolapo@gmail.com', 'data' => ['name' => 'Omodolapo Alu', 'dept' => 'Witty', 'co_members' => $this->co_witty, 'co_early' => $this->earl_witty, 'co_late' => $this->late_witty, 'co_absent' => $this->abs_witty, 'link' => url('/attendance/report/Witty/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'auntymma123@gmail.com', 'data' => ['name' => 'Emily Clarkson', 'dept' => 'Word Factory', 'co_members' => $this->co_wf, 'co_early' => $this->earl_wf, 'co_late' => $this->late_wf, 'co_absent' => $this->abs_wf, 'link' => url('/attendance/report/Word Factory/' . $this->date), 'date' => $this->date]],
            ...
            //         ['email' => 'afagunjade@gmail.com', 'data' => ['name' => 'Ayo Fagunjade', 'dept' => 'Protocol', 'co_members' => $this->co_pro, 'co_early' => $this->earl_pro, 'co_late' => $this->late_pro, 'co_absent' => $this->abs_pro, 'link' => url('/attendance/report/Protocol/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'sopsco@yahoo.com', 'data' => ['name' => 'Kelvin Ekeh', 'dept' => 'Special Duties', 'co_members' => $this->co_special_duties, 'co_early' => $this->earl_special_duties, 'co_late' => $this->late_special_duties, 'co_absent' => $this->abs_special_duties, 'link' => url('/attendance/report/Special Duties/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'chineloihuoma.nnadi@gmail.com', 'data' => ['name' => 'Chinelo Ihuoma', 'dept' => 'Photismos', 'co_members' => $this->co_photismos, 'co_early' => $this->earl_photismos, 'co_late' => $this->late_photismos, 'co_absent' => $this->abs_photismos, 'link' => url('/attendance/report/Photismos/' . $this->date), 'date' => $this->date]],
            //         ['email' => 'nneomaudeariry@gmail.com', 'data' => ['name' => 'Nneoma Ekeh', 'dept' => 'Light', 'co_members' => $this->co_light, 'co_early' => $this->earl_light, 'co_late' => $this->late_light, 'co_absent' => $this->abs_light, 'link' => url('/attendance/report/Light/' . $this->date), 'date' => $this->date]],
