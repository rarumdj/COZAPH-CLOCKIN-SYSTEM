!(function (e) {
        ...
        e("#calendar_2").length &&
            e("#calendar_2").fullCalendar({
                ...
                eventRender: function (e, t) {
                    e.color == dangerColor && t.addClass("event-invers-danger"),
                        e.color == warningColor &&
                            t.addClass("event-invers-warning"),
                        e.color == infoColor && t.addClass("event-invers-info"),
                        e.color == successColor &&
                            t.addClass("event-invers-success"),
                        e.color == primaryColor &&
                            t.addClass("event-invers-primary");
                },
            });
})(jQuery),
    $(function () {
        ...
        if ($("#stat-line_1").length) {
            (a = (t = $("#stat-line_1")
                ...
                30,
                0
            )).addColorStop(0, "#B721FF"),
                a.addColorStop(1, "#21D4FD");
            new Chart(t, {
                type: "line",
                data: {
                    labels: [
        ...
        if ($("#stat-line_2").length) {
            (a = (t = $("#stat-line_2")
                ...
                30,
                0
            )).addColorStop(0, "#08AEEA"),
                a.addColorStop(1, "#2AF598");
            new Chart(t, {
                type: "line",
                data: {
                    labels: [
        ...
        if ($("#stat-line_3").length) {
            (a = (t = $("#stat-line_3")
                ...
                30,
                0
            )).addColorStop(0, "#FEE140"),
                a.addColorStop(1, "#FA709A");
            new Chart(t, {
                type: "line",
                data: {
                    labels: [
        ...
        if ($("#stat-line_4").length) {
            ...
            (a = (t = $("#stat-line_4")
                ...
                30,
                0
            )).addColorStop(0, "#ff7fc7"),
                a.addColorStop(1, "#43b4ff");
            new Chart(t, {
                type: "line",
                data: {
                    labels: [
        ...
        if (
            ...
            $("#cpu-performance").length)
        ) {
            var l,
                n = (l = document
                    .getElementById("cpu-performance")
                    .getContext("2d")).createLinearGradient(0, 0, 0, 0);
            n.addColorStop(0, "rgba(255, 255, 225,0.5)"),
                n.addColorStop(1, "rgba(255, 255, 225,0.5)"),
                new Chart(l, {
                    type: "line",
                    data: {
                        labels: [
                        ...
                        datasets: [
                            {
                                label: "CPU Usage",
                                data: [
                                    56, 55, 59, 59, 59, 57, 56, 57, 54, 56, 58,
                                    57, 59, 58, 59, 57, 55, 56, 54, 52, 49, 48,
                                    50, 50, 46, 45, 49, 50, 52, 53, 52, 55, 54,
                                    53, 56, 55, 56, 55, 54, 55, 57, 58, 56, 55,
                                    56, 57, 58, 59, 58, 57, 55, 53, 52, 55, 57,
                                    55, 54, 52, 55, 57, 56, 57, 58, 59, 58, 59,
                                    57, 56, 55, 57, 58, 59, 60, 62, 60, 59, 58,
                                    57, 56, 57, 56, 58, 59,
                                ],
                                borderColor: chartColors[0],
                                backgroundColor: n,
                            ...
                            },
                            {
                                label: "Ram Usage",
                                data: [
                                    32, 25, 29, 29, 29, 27, 26, 27, 24, 26, 28,
                                    27, 29, 28, 29, 27, 25, 26, 24, 20, 18, 21,
                                    19, 17, 14, 13, 16, 15, 17, 18, 19, 22, 20,
                                    23, 21, 25, 24, 22, 25, 27, 25, 26, 24, 20,
                                    18, 18, 18, 22, 19, 23, 25, 23, 22, 25, 27,
                                    25, 24, 22, 25, 27, 26, 27, 28, 29, 28, 29,
                                    27, 26, 25, 27, 28, 29, 26, 27, 25, 29, 28,
                                    27, 26, 27, 26, 28, 29,
                                ],
    ...
    $(function () {
        "use strict";
        $("#sample-data-table").length && $("#sample-data-table").DataTable({}),
            $("#json-sample-data-table").length &&
            ...
            $("#complex-header-table").length &&
                $("#complex-header-table").DataTable({ stateSave: !0 }),
            $("#horizontal-scroll-table").length &&
    ...
    (function (e) {
                ...
                (function e(t, a) {
                    for (var r = t.firstChild; r; r = r.nextSibling)
                        3 === r.nodeType
                            ...
                            : 1 === r.nodeType &&
                              (o.push({ event: "start", offset: a, node: r }),
                              (a = e(r, a)),
        ...
        function w(e, t, i, a) {
                    ...
                    null != h.sL
                        ...
                        : (function () {
                              ...
                              for (
                                  ...
                                  (r += f(g.substring(t, a.index))),
                                      (o = h),
                                      (l = a),
                                      (n = u.cI ? l[0].toLowerCase() : l[0]),
                                      (e = o.k.hasOwnProperty(n) && o.k[n])
                                          ? ((b += e[1]),
                                            (r += s(e[0], f(a[0]))))
                                          : (r += f(a[0])),
                                      (t = h.lR.lastIndex),
            ...
            function r(e, t) {
                ...
                if (l) {
                    ...
                    return (
                        l.starts &&
                            (l.endSameAsBegin && (l.starts.eR = l.eR),
                            c(l.starts)),
                        n.rE ? 0 : t.length
                    );
                }
                if (((r = t), (o = h), !i && y(o.iR, r)))
                    throw new Error(
                        'Illegal lexeme "' +
                            t +
                            '" for mode "' +
            ...
            var o,
                ...
                l = {},
                p = "";
            for (o = h; o !== u; o = o.parent)
                o.cN && (p = s(o.cN, "", !0) + p);
            var g = "",
                b = 0;
            try {
                for (var n, v, m = 0; (h.t.lastIndex = m), (n = h.t.exec(t)); )
                    (v = r(t.substring(m, n.index), n[0])), (m = n.index + v);
                for (r(t.substr(m)), o = h; o.parent; o = o.parent)
                    o.cN && (p += A);
                return { r: b, value: p, language: e, top: h };
            } catch (e) {
                if (e.message && -1 !== e.message.indexOf("Illegal"))
                    return { r: 0, value: f(t) };
                throw e;
            }
        }
        function x(a, e) {
        ...
        function t(e) {
            var t,
                ...
                u = (function (e) {
                    var t,
                        ...
                        l = e.className + " ";
                    if (
                        ((l += e.parentNode ? e.parentNode.className : ""),
                        (a = S.exec(l)))
                    )
                        return k(a[1]) ? a[1] : "no-highlight";
            ...
            p(u) ||
                ...
                (e.className =
                    ...
                    (d = i ? m[i] : s),
                    (c = [n.trim()]),
                    n.match(/\bhljs\b/) || c.push("hljs"),
                    -1 === n.indexOf(d) && c.push(d),
                    c.join(" ").trim())),
        ...
        return (
            ...
            (o.CBCM = o.C("/\\*", "\\*/")),
            (o.HCM = o.C("#", "$")),
            (o.NM = { cN: "number", b: o.NR, r: 0 }),
            (o.CNM = { cN: "number", b: o.CNR, r: 0 }),
            (o.BNM = { cN: "number", b: o.BNR, r: 0 }),
            (o.CSSNM = {
                cN: "number",
                b:
                    o.NR +
            ...
            (o.TM = { cN: "title", b: o.IR, r: 0 }),
            (o.UTM = { cN: "title", b: o.UIR, r: 0 }),
            (o.METHOD_GUARD = { b: "\\.\\s*" + o.UIR, r: 0 }),
            o
        );
    }),
    ...
    $(function () {
        "use strict";
        $("#kanban-board-wrapper").length &&
            $("#board-category_1,#board-category_2,#board-category_3").sortable(
                {
                    connectWith:
                        "#board-category_1,#board-category_2,#board-category_3",
                    items: ".task-item",
                }
            );
    }),
    (function (t) {
        t(".alert.dismissible-alert").append(
            '<i class="alert-close mdi mdi-close"></i>'
        ),
            t(".alert.dismissible-alert .alert-close").on("click", function () {
                t(this).parent().slideToggle();
            }),
            t("#alert-notification-toggler-top").click("on", function () {
                t("body").append(
                    '            <div class="alert-notification-wrapper top">                <div class="alert-notification dismissible-alert">                    <p><b>Welcome !&nbsp;</b>Bernice Ingram</p>                    <i class="alert-close mdi mdi-close"></i>                </div>            </div>        '
                ),
                    t(
                        ".alert-notification-wrapper .dismissible-alert .alert-close"
                    ).on("click", function () {
                        t(this)
                            .parentsUntil(".alert-notification-wrapper")
                            .slideToggle();
                    });
            }),
            t("#alert-notification-toggler-bottom").click("on", function () {
                t("body").append(
                    '            <div class="alert-notification-wrapper bottom">                <div class="alert-notification dismissible-alert">                    <p><b>Welcome !&nbsp;</b>Bernice Ingram</p>                    <i class="alert-close mdi mdi-close"></i>                </div>            </div>        '
                ),
                    t(
                        ".alert-notification-wrapper .dismissible-alert .alert-close"
                    ).on("click", function () {
...
$(".navigation-menu li a", TemplateSidebar).each(function () {
    ...
    "" === current
        ? -1 !== e.attr("href").indexOf("index.html") &&
          ...
          $(this).parents(".navigation-submenu").length &&
    ...
    $(".sidebar .navigation-menu > li > a[data-toggle='collapse']").on(
        "click",
        function () {
    ...
    $(".email-compose-toolbar .toolbar-menu .delete-draft").on(
        "click",
        function () {
    ...
    $(
        ".email-compose-wrapper .email-compose-header .header-controls .compose-minimize"
    ).on("click", function () {
        $(this).addClass("minimized"),
            $(".email-compose-wrapper").addClass("compose-minimized"),
            $(this)
                .parentsUntil(".email-compose-header")
                .append('<div class="header-ovelay"></div>'),
    ...
    $(".animated-count").length &&
        $(".animated-count").counterUp({ delay: 50, time: 800 }),
    $('[data-toggle="tooltip"]').tooltip({ animation: !0, delay: 100 }),
    (function (e) {
        "use strict";
        var t = [
        ...
        if (e("#sample_c3-line-chart").length)
            c3.generate({
        ...
        if (e("#sample_c3-area-chart").length)
            c3.generate({
        ...
        if (e("#sample_c3-bar-chart").length)
            c3.generate({
        ...
        if (e("#sample_c3-stacked-bar-chart").length)
            c3.generate({
        ...
        if (e("#sample_c3-step-chart").length)
            c3.generate({
        ...
        if (e("#sample_c3-scattered-plot-chart").length)
            c3.generate({
        ...
        if (e("#sample_c3-donut-chart").length)
            c3.generate({
        ...
        if (e("#sample_c3-pie-chart").length)
            c3.generate({
                ...
                data: {
                    ...
                    colors: {
                        Absent: "rgb(220,20,60)",
                        Present: "rgb(34,139,34)",
                    },
                    type: "pie",
                    onclick: function (e, t) {
                        console.log("onclick", e, t);
        ...
        $(document).on("change", ".date-pick1", function () {
            var date = $(this).val();
            // console.log(dateP);
        ...
        if (e("#sample_c3-guage-chart").length)
            c3.generate({
    ...
    $(function () {
        ...
        if (
            ($("#chartist-line-with-area").length &&
                new Chartist.Line(
                    "#chartist-line-with-area",
                    {
        ...
        if (
            ($("#chartist-stacked-bar-chart").length &&
                new Chartist.Bar(
                    ...
                    "bar" === e.type &&
                        e.element.attr({ style: "stroke-width: 30px" });
                }),
...
$(".curved-mode").length &&
    (Chart.elements.Rectangle.prototype.draw = function () {
        ...
        if (
            ((n = s.horizontal
                ? ((e = s.base),
                  ...
                  (o = e < t ? 1 : -1),
                  (l = 1),
                  s.borderSkipped || "left")
                : ((e = s.x - s.width / 2),
                  (t = s.x + s.width / 2),
                  (o = 1),
                  (l = (a = s.y) < (r = s.base) ? 1 : -1),
                  s.borderSkipped || "bottom")),
            d)
        ) {
        ...
        for (var w = 1; w < 4; w++) {
            ...
            (C = f(w)),
                ...
                (nextCorner = f(nextCornerId)),
                (width = v[2][0] - v[1][0]),
                (height = v[0][1] - v[1][1]),
                (x = v[1][0]),
                (y = v[1][1]),
                (k = 20) > height / 2 && (k = height / 2),
                k > width / 2 && (k = width / 2),
                i.moveTo(x + k, y),
                i.lineTo(x + width - k, y),
                i.quadraticCurveTo(x + width, y, x + width, y + k),
                i.lineTo(x + width, y + height - k),
                i.quadraticCurveTo(
                    x + width,
                    y + height,
                    x + width - k,
                ...
                i.lineTo(x + k, y + height),
                i.quadraticCurveTo(x, y + height, x, y + height - k),
                i.lineTo(x, y + k),
                i.quadraticCurveTo(x, y, x + k, y);
        }
        i.fill(), d && i.stroke();
    }),
    $(".chartjs-chart").length &&
        ...
        (Chart.defaults.global.tooltips.custom = function (o) {
            ...
            if (
                ...
                if (
                    ...
                    t.forEach(function (e) {
                        ...
                        (l += "</tbody>"),
                        (e.querySelector("table").innerHTML = l);
                }
                var r = this._chart.canvas.getBoundingClientRect();
                (e.style.opacity = 1),
                    (e.style.position = "absolute"),
                    (e.style.left =
                        r.left + window.pageXOffset + o.caretX + "px"),
                    (e.style.top =
                        r.top + window.pageYOffset + o.caretY + "px"),
                    (e.style.fontFamily = o._bodyFontFamily),
                    (e.style.fontSize = o.bodyFontSize + "px"),
                    (e.style.fontStyle = o._bodyFontStyle),
                    (e.style.padding = o.yPadding + "px " + o.xPadding + "px"),
    ...
    $(function () {
        ...
        if ($("#chartjs-staked-area-chart").length) {
            var e = {
                ...
                t = document
                    .getElementById("chartjs-staked-area-chart")
                    .getContext("2d");
            new Chart(t, e);
        }
        if ($("#chartjs-staked-line-chart").length) {
            (e = {
                ...
                (t = document
                    .getElementById("chartjs-staked-line-chart")
                    .getContext("2d"));
            new Chart(t, e);
        }
        ...
        if ($("#chartjs-staked-bar-chart").length)
            (a = {
                ...
                (r = $("#chartjs-staked-bar-chart").get(0).getContext("2d")),
                new Chart(r, {
                    type: "bar",
                    data: a,
                    options: {
    ...
    (function (e) {
        "use strict";
        if (
            (e("#summernoteExample").length &&
                e("#summernoteExample").summernote({ height: 300, tabsize: 2 }),
            e("#tinyMceExample").length &&
                tinymce.init({
            ...
            new SimpleMDE({ element: e("#simpleMde")[0] });
    })(jQuery),
    $(function () {
        "use strict";
        var e = require("switchery");
        if (
            ($("#js-select-example").length &&
                $("#js-select-example").select2(),
            $("#switchery-primary").length)
        )
            new e(document.querySelector("#switchery-primary"), {
                className: "switchery switch-primary",
                color: "#f3f5f6",
            });
        if ($("#switchery-success").length)
            new e(document.querySelector("#switchery-success"), {
                className: "switchery switch-success",
                color: "#f3f5f6",
            });
        if ($("#switchery-warning").length)
            new e(document.querySelector("#switchery-warning"), {
                className: "switchery switch-warning",
                color: "#f3f5f6",
            });
        if ($("#switchery-danger").length)
            new e(document.querySelector("#switchery-danger"), {
                className: "switchery switch-danger",
                color: "#f3f5f6",
            });
        if ($("#switchery-info").length)
            new e(document.querySelector("#switchery-info"), {
    ...
    (function (e) {
        "use strict";
        e(".enable-mask.date-mask").mask("00/00/0000"),
            e(".enable-mask.time-mask").mask("00:00:00"),
            e(".enable-mask.phone-mask").mask("(00) 0000-0000"),
            e(".enable-mask.ip_address-mask").mask("0ZZ.0ZZ.0ZZ.0ZZ", {
                translation: { Z: { pattern: /[0-9]/, optional: !0 } },
            }),
    ...
    $(function (e) {
        ...
        if (e(a).length) {
            ...
            d = {
                ...
                colors: chartColors,
                series: [
                    { name: "PRODUCT A", data: p[0] },
                    { name: "PRODUCT B", data: p[1] },
                    { name: "PRODUCT C", data: p[2] },
                ],
            ...
            d = {
                ...
                series: [
                    ...
                    },
                    {
                        name: "Desktops",
                        data: [
                            233, 423, 352, 272, 432, 224, 107, 133, 458, 229,
                        ],
                    },
                ],
                grid: {
...
var dataSeries = [
        ...
        [
            ...
            { date: "2014-01-09", value: 143762210 },
    ...
    series = {
        ...
        monthDataSeries2: {
            prices: [
                ...
                8668.95, 8602.3, 8607.55, 8512.9, 8496.25, 8600.65, 8881.1,
                9040.85, 8340.7, 8165.5, 8122.9, 8107.85, 8128,
            ],
            dates: [
                "13 Nov 2017",
                "14 Nov 2017",
        ...
        monthDataSeries3: {
            prices: [
                7114.25, 7126.6, 7116.95, 7203.7, 7233.75, 7451, 7381.15,
                7348.95, 7347.75, 7311.25, 7266.4, 7253.25, 7215.45, 7266.35,
                7315.25, 7237.2, 7191.4, 7238.95, 7222.6, 7217.9, 7359.3,
                7371.55, 7371.15, 7469.2, 7429.25, 7434.65, 7451.1, 7475.25,
                7566.25, 7556.8, 7525.55, 7555.45, 7560.9, 7490.7, 7527.6,
                7551.9, 7514.85, 7577.95, 7592.3, 7621.95, 7707.95, 7859.1,
                7815.7, 7739, 7778.7, 7839.45, 7756.45, 7669.2, 7580.45,
                7452.85, 7617.25, 7701.6, 7606.8, 7620.05, 7513.85, 7498.45,
                7575.45, 7601.95, 7589.1, 7525.85, 7569.5, 7702.5, 7812.7,
                7803.75, 7816.3, 7851.15, 7912.2, 7972.8, 8145, 8161.1, 8121.05,
                8071.25, 8088.2, 8154.45, 8148.3, 8122.05, 8132.65, 8074.55,
                7952.8, 7885.55, 7733.9, 7897.15, 7973.15, 7888.5, 7842.8,
                7838.4, 7909.85, 7892.75, 7897.75, 7820.05, 7904.4, 7872.2,
                7847.5, 7849.55, 7789.6, 7736.35, 7819.4, 7875.35, 7871.8,
                8076.5, 8114.8, 8193.55, 8217.1, 8235.05, 8215.3, 8216.4,
                8301.55, 8235.25, 8229.75, 8201.95, 8164.95, 8107.85, 8128,
                8122.9, 8165.5, 8340.7, 8423.7, 8423.5, 8514.3, 8481.85, 8487.7,
                8506.9, 8626.2,
            ],
            dates: [
                "02 Jun 2017",
